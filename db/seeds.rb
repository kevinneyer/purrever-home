...
cat3 = Cat.create(name: "Alfie" , breed: Faker::Creature::Cat.breed, age: rand(1..15) , favorite_food:Faker::Food.dish, image_url: "https://external-content.duckduckgo.com/iu/?u=http%3A%2F%2Fwww.cutenessoverflow.com%2Fwp-content%2Fuploads%2F2015%2F05%2Fcat-tongue-out-52.jpg&f=1&nofb=1")
...
cat11 = Cat.create(name: "Felix", breed: Faker::Creature::Cat.breed, age: rand(1..15) , favorite_food:Faker::Food.dish, image_url: "https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse2.mm.bing.net%2Fth%3Fid%3DOIP.ziatQh7we-JLJ09XFJjbYgHaLH%26pid%3DApi&f=1")
cat12 = Cat.create(name: "Smokey", breed: Faker::Creature::Cat.breed, age: rand(1..15) , favorite_food:Faker::Food.dish, image_url: "https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse4.mm.bing.net%2Fth%3Fid%3DOIP.Zy4ktVKYWHO7HW3_1iqutwAAAA%26pid%3DApi&f=1")
...
Listing.create(title: titles.sample , content:Faker::Movies::PrincessBride.quote , date_added: Faker::Date.between(from: 2.months.ago, to: Date.today), adoption_center_id: AdoptionCenter.all.sample.id, cat_id: cat3.id)
...
Listing.create(title: titles.sample , content:Faker::Movies::PrincessBride.quote , date_added: Faker::Date.between(from: 2.months.ago, to: Date.today), adoption_center_id: AdoptionCenter.all.sample.id, cat_id: cat11.id)
Listing.create(title: titles.sample , content:Faker::Movies::PrincessBride.quote , date_added: Faker::Date.between(from: 2.months.ago, to: Date.today), adoption_center_id: AdoptionCenter.all.sample.id, cat_id: cat12.id)
